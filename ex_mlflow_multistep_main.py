"""
    Multistep workflow main file for MLflow
    Inspired by https://raw.githubusercontent.com/mlflow/mlflow/master/examples/multistep_workflow/main.py
"""
...
def get_steps():
    with open("MLproject") as f:
        ...
        return [k for k, _ in content["entry_points"].items()]
...
# This is not great because it doesn't account for:
# - changes in code
...
def workflow():
    ...
    with mlflow.start_run() as active_run:
        ...
        for step in get_steps():
            run = _get_or_run(step, {}, git_commit)
